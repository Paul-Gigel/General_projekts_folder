...
/*--------------------------------------------------------------Problrmkindende------------------------------------------------------------------------------------------------------------------------------*/
    ...
    void createVertexBuffer()   {
        ...
        allocInfo.memoryTypeIndex = findMemoryType(memRequirements.memoryTypeBits,(VkMemoryPropertyFlagBits)((uint32_t)VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | (uint32_t)VK_MEMORY_PROPERTY_HOST_COHERENT_BIT));
    ...
    uint32_t findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlagBits properties)   {
        ...
        throw std::runtime_error("failed to find suitable memory Device!");
    }
    void createCommandBuffers()  {
        ...
        if (vkAllocateCommandBuffers(device, &allocInfo, &commandBuffers[currentFrame]) != VK_SUCCESS) {
            throw std::runtime_error("failed to allocate comannd buffers");
        }
    }
